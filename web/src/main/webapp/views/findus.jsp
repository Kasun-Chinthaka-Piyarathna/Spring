<md-content>
    ...
    <div class="findus">
        ...
        <md-card md-theme="{{ showDarkTheme ? 'dark-blue' : 'default' }}" md-theme-watch
                 style="background-image:url(js/Lib/slider/images/bg21.jpg) ">
            ...
            <md-card-title>
                ...
                <md-card-title-media>
                    <div class="md-media-lg card-media">
                        ...
                        <img ng-src="{{restaurant.RImage}}" class="md-card-image" alt="Washed Out"
            ...
            <md-card-actions layout="row" layout-align="end center">
                <div layout="row" ng-cloak md-theme="{{theme}}" class="container">
                    ...
                    <md-button class="md-primary md-raised" ng-click="showAdvanced(ev ,restaurant)"
                               style="background-color: darkgreen">ADD A COMMENT
                    </md-button>
                </div>
                ...
                <md-card md-theme="{{ showDarkTheme ? 'dark-purple' : 'default' }}" md-theme-watch>
                    <div class="acidjs-rating-stars">
                        <form class="ng-pristine ng-valid" style="width:121px">
                            <input ng-model="rating" type="radio" name="group-1" id="group-1-0" value="50"/><label
                                for="group-1-0"></label>
                            <input ng-model="rating" type="radio" name="group-1" id="group-1-1" value="40"/><label
                                for="group-1-1"></label>
                            <input ng-model="rating" type="radio" name="group-1" id="group-1-2" value="30"/><label
                                for="group-1-2"></label>
                            <input ng-model="rating" type="radio" name="group-1" id="group-1-3" value="20"/><label
                                for="group-1-3"></label>
                            <input ng-model="rating" type="radio" name="group-1" id="group-1-4" value="10"/><label
                                for="group-1-4"></label>
                        </form>
                    </div>
                </md-card>
        ...
        <div layout="row" layout-wrap ng-show="loggedIn">
            <div ng-repeat="item in restaurant.AvailableFoodItems" flex="25">
                <md-card md-theme="{{ showDarkTheme ? 'dark-blue' : 'default' }}" md-theme-watch
                         style="background-image:url(js/Lib/slider/images/bg23.jpg) ">

                    <md-card-title>
                        <md-card-title-text>
                            <span class="md-headline" style="color:#510BE7">{{item.name}}</span>
                            <span class="md-subhead"
                                  style="color: #3e8f3e"> Avalable Quantity : {{item.quantity}}</span>
                        </md-card-title-text>
                        <!--<md-card-title-media>-->
                        <!--<div class="md-media-lg card-media">-->
                    ...
                    <md-card-actions layout="row" layout-align="end center">
                        ...
                        <div class="btn-group" ng-init="style={'background-color':'#204d74'}">
                            <md-button ng-click="addToCart(item , quantity_new);style1=style"
                                       style="background-color: #2299dd" class="btn btn-default" ng-style="style1">Add
                                To Cart
                            </md-button>
                        </div>
                    </md-card-actions>
        ...
        <md-card md-theme="{{ showDarkTheme ? 'dark-blue' : 'default' }}" md-theme-watch
                 style="background-image:url(js/Lib/slider/images/bg8.jpg) ">
