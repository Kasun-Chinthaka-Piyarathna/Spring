...
(function () {
    ...
    function customerRegisterService($http) {
        ...
        function customerSignUp(filters) {
            return $http.post(webApi + 'customer/signUp?cname=' + filters.cname + '&phone=' + filters.phone+ '&email=' + filters.email+ '&nic=' + filters.nic+ '&username=' + filters.username+ '&pwd=' + filters.pwd).then(handleSuccess, handleError('Error getting drivers'));
        }
